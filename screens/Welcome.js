  ...
  render(){
    return(
      <View style={styles.container}>
        ...
        <View style={styles.profileContainer,{borderWidth:20,alignItems:'center',width:"50%",marginLeft:500,borderColor:"white",marginTop:-800}}>
          <Text style={styles.title}>Barter</Text>
          <Text style={{color:'#ff8a65'}}> A Trading Method </Text>
        </View>
        <View style={styles.buttonContainer}>
          <Text style={{color:'#ff5722', fontSize:18, fontWeight:'bold',marginLeft:800}}>Username</Text>
          ...
          <Text style={{color:'#ff5722', fontSize:18, fontWeight:'bold',marginLeft:800}}>Password</Text>
          <View style={{alignItems:'center'}}>
            <TextInput
              style={styles.loginBox}
              secureTextEntry = {true}
          ...
          <View style={{alignItems:'center'}}>
            <TouchableOpacity
              style={[styles.button,{marginBottom:10,width:250}]}
